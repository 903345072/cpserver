...
class basketGame extends Model
{
    /**
     ...
     * @var string
     */
    protected $table = 'eb_basketball_mix_odds';
    ...
    protected $dtime;
    protected $appends = ['stop_time','week','suffix_num','goal',"dxf"];


    public function getStopTimeAttribute()
    {
        $game_time = Config::get("gameTime")["basket"];
        return getStopTime($this->attributes["dtime"],$game_time,"basket");
    ...
    public function getDxfAttribute()
    {
        return explode(",",$this->attributes["p_goal"])[3];
